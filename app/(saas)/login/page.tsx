...
// Separated because useSearchParams needs Suspense boundary
function LoginForm() {
    ...
    <div className="min-h-screen bg-gray-50 flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        ...
        <div className="bg-white rounded-2xl border border-gray-200 p-8 shadow-sm">
          <Suspense fallback={<div className="h-48 flex items-center justify-center"><Loader2 size={20} className="animate-spin text-gray-300" /></div>}>
            <LoginForm />
          </Suspense>
        </div>
